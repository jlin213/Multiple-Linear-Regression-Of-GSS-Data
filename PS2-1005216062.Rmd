...
\begin{center} $y_{i}$ = $\beta_{0}$ + $\beta_{1}$$X_{i:25-49}$ + $\beta_{2}$$X_{inc:50-74}$ + $\beta_{3}$$X_{inc:75-99}$ + $\beta_{4}$$X_{inc100-124}$ + $\beta_{5}$$X_{inc:>125}$ + $\beta_{6}$$X_{children}$ + $\beta_{7}$$X_{mar:Married}$ \end{center} (1)
